...
intros dt dx; rewrite (plus_S dt); rewrite <- (plus_n_Sm dt); intros;
 apply (Pas_hh Q Q' Q'' Q''); auto with v62.
...
intros dt; rewrite plus_un; intros; rewrite <- H8; rewrite <- (plus_zero x);
 apply (demi_Pas_h P' Q'' P''); auto with v62.
rewrite H8; rewrite plus_zero; auto with v62.
Qed.
...
apply H5; auto with v62.
do 2 apply lt_S_n; rewrite H8; auto with v62.
...
rewrite plus_zero; rewrite H9; auto with v62.
...
apply H5; auto with v62.
rewrite plus_deux; rewrite <- H8; auto with v62.
...
apply H2; auto with v62.
rewrite <- plus_n_Sm; rewrite <- H9; auto with v62.
...
intros; apply (Pas_bb Q Q' Q'' Q''); auto with v62.
apply H2; auto with v62.
rewrite <- plus_n_Sm; rewrite <- H8; auto with v62.
...
intros; apply (Pas_bb Q Q' Q'' Q''); auto with v62.
apply H2; auto with v62.
rewrite <- plus_n_Sm; rewrite <- H7; auto with v62.
