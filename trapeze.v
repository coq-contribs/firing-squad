...
replace un with (S (double 0)); auto with v62.
apply Ht1_VV; auto with v62.
Qed.
...
intros; rewrite R1'.
elim (A_ZCB t x (S cote)); auto with v62; intros.
apply vv_vert.
rewrite <- plus_S; apply A_Vg; auto with v62.
...
apply le_SSS_triple; auto with v62.

elim H0; intros; rewrite <- (plus_zero (S t)); apply H1; auto with v62.

elim H0; intros; rewrite <- (plus_un (S t)); apply H1; auto with v62.
elim H; intros; apply le_n_triplem; apply le_S_n; auto with v62.
...
rewrite plus_Snm_nSm; apply inclus_vert with (t := S t) (haut := six);
 auto with v62.
rewrite plus_trois; rewrite plus_six; auto with v62.

rewrite <- (plus_quatre x); apply inclus_vert with (t := S t) (haut := six);
 auto with v62.
rewrite plus_deux; rewrite plus_six; auto with v62.
Qed.
...
rewrite <- plus_Snm_nSm; apply ZCB_Ht1; auto with v62.
elim H1; intros; apply A_ZCB; auto with v62.
rewrite <- (plus_zero (S t)); apply H2; auto with v62.

rewrite <- (plus_un (S t)); apply H2; auto with v62.
apply le_n_triplem; apply le_trans with (m := deux); auto with v62.
...
intros; rewrite R1.
apply vv_vert.
elim H0; intros; rewrite <- plus_S; apply B_Vg; auto with v62.
...
rewrite plus_Snm_nSm; apply inclus_vert with (t := S t) (haut := sept);
 auto with v62.
rewrite plus_trois; rewrite plus_sept; auto with v62.

rewrite <- (plus_quatre x); apply inclus_vert with (t := S t) (haut := sept);
 auto with v62.
rewrite plus_deux; rewrite plus_sept; auto with v62.
Qed.
...
do 2 rewrite <- plus_Snm_nSm; apply ZCB_Ht1; auto with v62.
elim H1; intros; apply B_ZCB; auto with v62.
rewrite <- (plus_zero (S t)); apply H2; auto with v62.
...
rewrite <- S_pred; auto with v62; apply R2; auto with v62.
Qed.
...
apply (GA_dollarC (S (S (S t))) (S x)); auto with v62.
apply G31.
...
apply (GC_dollarB (S (S (S (S t)))) (S x)); auto with v62.
apply G41.
...
generalize (H quatre); rewrite plus_quatre; auto with v62.
Qed.
...
rewrite plus_Snm_nSm; apply inclus_vert with (t := S t) (haut := huit);
 auto with v62.
rewrite plus_trois; rewrite plus_huit; auto with v62.

rewrite <- (plus_quatre x); apply inclus_vert with (t := S t) (haut := huit);
 auto with v62.
rewrite plus_deux; rewrite plus_huit; auto with v62.
Qed.
...
do 3 rewrite <- plus_Snm_nSm; apply ZCB_Ht1; auto with v62.
elim H1; intros; apply C_ZCB; auto with v62.
rewrite <- (plus_zero (S t)); apply H2; auto with v62.
