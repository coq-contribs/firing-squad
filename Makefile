...
all: $(VOFILES) $(CMOFILES) $(if $(HASNATDYNLINK_OR_EMPTY),$(CMXSFILES)) fire\
  extracted.ml extracted.mli
...
.PHONY: all opt byte archclean clean install uninstall_me.sh uninstall userinstall depend html validate all test
...
clean:
	...
	- rm -rf fire
	- rm -rf extracted.ml extracted.mli
